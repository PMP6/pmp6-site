...
let find_or_logout id =
  (* If the user doesn't exist (maybe he got deleted while his session
     was active, or some strange error happened), then logout as
     a defensive measure. *)
