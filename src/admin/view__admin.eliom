...
let main () =
  let make_li_elt module_ =
    ...
    Html.li [ Html.a ~service [ Html.txt name ] () ]
  in
  ...
  Content.page
    ...
    [
      ...
      H.p [ H.txt "Cliquez sur un lien pour accéder à l'administration de ce module." ];
      Html.ul ~a:[ Html.a_class [ "menu" ] ] @@ List.map ~f:make_li_elt all_modules;
    ]
